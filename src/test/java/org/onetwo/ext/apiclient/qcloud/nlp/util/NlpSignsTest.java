...
public class NlpSignsTest {
	...
	public void testSign() {
		...
		String signResult = NlpSigns.signHmac(signKey, signData, NlpSignTypes.HMAC_SHA256);
...
//		@FieldName("InstanceIds.0")
		...
		@Builder
		public DescribeInstancesRequest(String action, String region, int timestamp, int nonce, String secretId,
				String signature, String signatureMethod, String instanceIds_0) {
			super(action, region, timestamp, nonce, secretId, signature);
